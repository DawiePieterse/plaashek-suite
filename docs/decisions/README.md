...
16. ~~Whether Water and Werkswinkel could be built ahead of Stoor, out of §11's written order~~ — [ADR 0014](0014-water-werkswinkel-before-stoor.md): yes — §11's order was reuse-driven, not a dependency chain, and both modules are simpler and share the `assets` master-data gap this work closes once for both
