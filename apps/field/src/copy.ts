...
const af = {
  ...
  moveAction: "Beweeg",
  treatmentAction: "Behandeling",
  weighAction: "Weeg",
  animalLabel: "Dier",
  chooseAnimal: "Kies 'n dier…",
  chooseAnimals: "Kies die diere om te beweeg",
  noAnimals: "Geen diere gevind nie. Gaan na die hek vir sein.",
  noTag: "geen merk",
  toCampLabel: "Beweeg na kamp",
  chooseCamp: "Kies 'n kamp…",
  noCamps: "Geen kampe gevind nie. Gaan na die hek vir sein.",
  selectedAnimalsCount: (count: number) => `${count} dier(e) gekies`,
  treatmentTypeLabel: "Tipe behandeling",
  doseLabelOptional: "Dosis (opsioneel)",
  save: "Stoor",
...
const en: typeof af = {
  ...
  chooseAnimals: "Choose the animals to move",
  noAnimals: "No animals found. Go to the gate for signal.",
  noTag: "no tag",
  toCampLabel: "Move to camp",
  chooseCamp: "Choose a camp…",
  noCamps: "No camps found. Go to the gate for signal.",
  selectedAnimalsCount: (count: number) => `${count} animal(s) selected`,
  treatmentTypeLabel: "Treatment type",
  doseLabelOptional: "Dose (optional)",
  save: "Save",
