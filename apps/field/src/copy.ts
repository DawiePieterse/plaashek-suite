...
const af = {
  ...
  noAssets: "Geen bates gevind nie. Gaan na die hek vir sein.",
  readingLabel: "Lesing",
  noteOptionalLabel: "Nota (opsioneel)",
  fuelKind: "Brandstof",
  issueKind: "Probleem",
  litresLabel: "Liter",
  odometerLabel: "Kilometerteller (opsioneel)",
  descriptionLabel: "Beskrywing",
  reportIssue: "Meld probleem",
  markResolved: "Merk klaar",
  save: "Stoor",
...
const en: typeof af = {
  ...
  noAssets: "No assets found. Go to the gate for signal.",
