...
const af = {
  ...
  cameraUnavailable: "Die kamera werk nie hier nie. Tik die kode wat op die kaart gedruk is.",
  cardCodeLabel: "Of tik die kaartkode",
  useCode: "Gebruik kode",
  changeCard: "Ander kaart",
  unknownCard: (code: string) => `Kaart ${code} — naam nog onbekend op hierdie foon. Die kantoor sal dit koppel.`,
  clockIn: "Klok in",
  clockOut: "Klok uit",
...
const en: typeof af = {
  ...
  cameraUnavailable: "The camera does not work here. Type the code printed on the card.",
  cardCodeLabel: "Or type the card code",
  useCode: "Use code",
  changeCard: "Another card",
  unknownCard: (code: string) => `Card ${code} — name not known on this phone yet. The office will match it.`,
  clockIn: "Clock in",
  clockOut: "Clock out",
