...
const af = {
  ...
  registrationsHeading: "Produkregistrasie",
  registrationsSubheading: "Vir onttrekkingstydperk en veilige-oesdatum-berekening. Nie elke voorraaditem het een nodig nie.",
  chooseItemOption: "Kies 'n voorraaditem…",
  noItemsToRegister: "Voeg eers 'n voorraaditem by onder Stoor.",
  noRegistrationsYet: "Nog geen registrasie nie.",
  activeIngredientLabel: "Aktiewe bestanddeel",
  defaultReasonLabel: "Rede (verstek, opsioneel)",
  lNumberLabel: "L-nommer (opsioneel)",
  withholdingPeriodLabel: "Onttrekkingstydperk (opsioneel)",
  addRegistration: "Voeg registrasie by",
...
const en: typeof af = {
  ...
  registrationsHeading: "Product registrations",
  registrationsSubheading: "For withholding-period and safe-harvest-date calculation. Not every stock item needs one.",
  chooseItemOption: "Choose a stock item…",
  noItemsToRegister: "Add a stock item under Stoor first.",
  noRegistrationsYet: "No registrations yet.",
  activeIngredientLabel: "Active ingredient",
  defaultReasonLabel: "Reason (default, optional)",
  lNumberLabel: "L-number (optional)",
  withholdingPeriodLabel: "Withholding period (optional)",
