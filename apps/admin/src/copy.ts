...
const af = {
  ...
  kuddeRegisterHeading: "Diereregister",
  animalTag: "Oormerk",
  animalSex: "Geslag",
  animalBreed: "Ras",
  animalBirthDate: "Geboortedatum",
  animalActive: "Aktief",
  animalTagPlaceholder: "bv. 014",
  animalSexPlaceholder: "bv. koei",
  animalBreedPlaceholder: "bv. Bonsmara",
  registerAnimal: "Registreer dier",
  saveAnimal: "Stoor",
  noAnimalsYet: "Nog geen diere geregistreer nie.",
  ...
  errors: {
    ...
    tag_number_taken: "Daardie oormerk is al aan 'n ander dier gegee.",
...
const en: typeof af = {
  ...
  kuddeRegisterHeading: "Animal register",
  animalTag: "Tag",
  animalSex: "Sex",
  animalBreed: "Breed",
  animalBirthDate: "Birth date",
  animalActive: "Active",
  animalTagPlaceholder: "e.g. 014",
  animalSexPlaceholder: "e.g. cow",
  animalBreedPlaceholder: "e.g. Bonsmara",
  ...
  errors: {
    ...
    tag_number_taken: "Another animal already has that tag.",
