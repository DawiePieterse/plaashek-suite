...
const af = {
  ...
  coordsHeading: "GPS-koördinate (vir weer)",
  coordsNote: "Die weer in die balk bo, en op vasleggings, kom van Open-Meteo vir hierdie punt.",
  latitude: "Breedtegraad",
  longitude: "Lengtegraad",
  pickOnMap: "Kies op kaart",
  pickOnMapHint: "Regskliek die plek op die kaart en kopieer die koördinate hierheen.",
  useMyLocation: "Gebruik my ligging",
  locating: "Soek ligging…",
  locationFailed: "Kon nie jou ligging kry nie. Tik die koördinate in of kies op die kaart.",
  coordsSaved: "Koördinate gestoor.",
  saveCoords: "Stoor",
  cancel: "Kanselleer",
  revoke: "Herroep",
...
const en: typeof af = {
  ...
  coordsHeading: "GPS coordinates (for weather)",
  coordsNote: "The weather in the bar above, and on captures, comes from Open-Meteo for this point.",
  latitude: "Latitude",
  longitude: "Longitude",
  pickOnMap: "Pick on map",
  pickOnMapHint: "Right-click the spot on the map and copy the coordinates back here.",
  useMyLocation: "Use my location",
  locating: "Finding location…",
  locationFailed: "Could not get your location. Type the coordinates or pick on the map.",
  coordsSaved: "Coordinates saved.",
  saveCoords: "Save",
  cancel: "Cancel",
  revoke: "Revoke",
