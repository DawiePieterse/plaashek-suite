...
import { AttendanceRollup, HarvestRollup, KuddeRollup, PieceworkPayout, StockRollup, WaterRollup, WorkOrderRollup } from "./panels/rollups.js";
...
const MODULE_PANELS: Record<ModuleTab, Panel> = {
  ...
  kudde: (extra) => (
    <>
      <KuddeRollup />
      {extra}
      <Exports kinds={["animals", "movements", "treatments", "weights"]} />
    </>
  ),
};
