 ...
 * Boord.
 */
export type ExportKind = "notes" | "harvest" | "attendance" | "stock" | "water" | "work-orders" | "fuel" | "piecework" | "bespuiting";
...
const PATHS: Record<ExportKind, string> = {
  ...
  bespuiting: "/export/bespuiting.csv",
};
